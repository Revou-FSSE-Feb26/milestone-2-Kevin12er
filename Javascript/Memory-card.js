...
(function () {
    ...
    btnStart.addEventListener("click", function() {
        ...
        randomCard.forEach(function(item) {
           ...
           cardBox.className = "border border-slate-700 bg-slate-500 rounded-xl cursor-pointer drop-shadow-glow-green active:scale-95 overflow-hidden h-28 md:h-48 lg:h-56 w-full flex items-center justify-center";
